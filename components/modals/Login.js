                          ...
                          <form onSubmit={handleSubmit(data => {saveFormData(data)})}>
                              <h4>Welcome back!</h4>
                                ...
                                <div className="form-group mb-4">
                                    ...
                                    <input type="password" className="form-control input-background"  name="password" id="password" placeholder="Password" {...register("password", {required: 'Password is required'})}/>
                                    <ErrorMessage
                                          errors={errors}
                                          name="password"
                                          render={({ message }) => <p className="text-danger">{message} </p>}
