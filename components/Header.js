        ...
        <div className="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" className="navbar">
                <ul>
                    ...
                    <li><a className="nav-link scrollto" href="#" data-bs-toggle="modal"  onClick={(e) => loginShowModal(e)}>Login</a></li>
                    <li><a className="getstarted scrollto" href="#signUpModal" data-bs-toggle="modal"  onClick={(e) => signupShowModal(e)}>Join for free</a></li>
                </ul>
